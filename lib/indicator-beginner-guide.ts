...
export const beginnerStarterLessons: readonly StarterLesson[] = [
  { step: "1", slug: "support-resistance", role: "位置", title: "先找關鍵位置", body: "先分清支撐、阻力和區間中段，知道訊號出現在哪裡。" },
  { step: "2", slug: "volume", role: "量能", title: "再看有沒有人參與", body: "用成交量確認突破、跌破或反彈是否得到市場參與。" },
  { step: "3", slug: "ema", role: "方向", title: "判斷大方向", body: "用一條 EMA 看趨勢和節奏，不要同時堆疊多條均線。" },
  { step: "4", slug: "rsi", role: "力度", title: "檢查升跌力度", body: "用 RSI 看力度是否過熱、過弱或背離，但不要把數字當買賣指令。" },
...
export const indicatorLearningGoals: readonly IndicatorLearningGoal[] = [
  ...
  { id: "volume", label: "我想確認成交", uses: ["確認量能"] },
  { id: "risk", label: "我想看波動或管理風險", uses: ["管理風險", "觀察波動"] },
  { id: "levels", label: "我想找區間或關鍵位置", uses: ["支撐阻力", "判斷盤整"] },
];
