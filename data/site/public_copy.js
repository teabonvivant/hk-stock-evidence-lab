window.__PUBLIC_COPY__ = {
  ...
  "global": {
    "siteName": "技術指標研究室",
    "tagline": "先讀圖，再決定用甚麼指標",
    "riskDisclaimer": "只作教育研究，不構成投資建議；任何交易都要自己承擔風險。",
    "dataDisclaimer": "圖表示範使用本地歷史開、高、低、收及成交量資料，不提供即時行情。",
    "navigation": {
      "home": "總覽",
      "learn": "學習",
      "indicators": "指標庫",
  ...
  "indicators": [
    {
      ...
      "nameZh": "累積派發線",
      "summary": "A/D 線透過收盤價在高低區間的位置判斷量能是偏向累積還是派發。",
      "signals": [
      ...
      "judgmentZh": "理查・威科夫優勝，因其在原創性、專屬性與資料覆蓋上最強；主要對照者為約瑟夫・格蘭維爾、巴夫・多米爾。"
    },
    {
      ...
      "judgmentZh": "內德・戴維斯優勝，因其在原創性、專屬性與資料覆蓋上最強；主要對照者為拉瑞・威廉斯、拉爾夫・文斯。"
    },
    {
      "slug": "adx",
      "siteSlug": "adx",
      ...
      "judgmentZh": "威爾斯・威爾德是目前資料庫中唯一對應「ADX / DMI」的核心專家。"
    },
    {
      "slug": "aroon",
      "siteSlug": "aroon",
      "nameZh": "阿隆指標",
      "summary": "Aroon 透過近期高低點出現時間判斷趨勢是否活躍，適合觀察新高新低節奏。",
      "signals": [
      ...
      "judgmentZh": "圖沙・昌德是目前資料庫中唯一對應「Aroon 指標」的核心專家。"
    },
    {
      "slug": "atr",
      "siteSlug": "atr",
      ...
      "judgmentZh": "威爾斯・威爾德優勝，因其在原創性、專屬性與資料覆蓋上最強；主要對照者為奧利維耶・塞班。"
    },
    {
      ...
      "judgmentZh": "拉瑞・威廉斯優勝，因其在原創性、專屬性與資料覆蓋上最強；主要對照者為羅伯特・科爾比、馬丁・普林格。"
    },
    {
      "slug": "beta",
      "siteSlug": "beta",
      ...
      "judgmentZh": "彼得・馬丁、拜倫・麥肯並列優勝；此指標/方法屬共同創作或共同權威，應並讀其資料。"
    },
    {
      ...
      "judgmentZh": "約翰・布林格優勝，因其在原創性、專屬性與資料覆蓋上最強；主要對照者為傑瑞米・杜普萊西斯。"
    },
    {
    ...
    },
    {
      ...
      "judgmentZh": "唐納德・蘭伯特是目前資料庫中唯一對應「CCI 商品通道指標」的核心專家。"
    },
    {
      ...
      "judgmentZh": "馬克・柴金是目前資料庫中唯一對應「Chaikin 資金流」的核心專家。"
    },
    {
    ...
    },
    {
      ...
      "judgmentZh": "圖沙・昌德是目前資料庫中唯一對應「Chande 動量震盪器」的核心專家。"
    },
    {
    ...
    },
    {
      ...
      "judgmentZh": "艾德溫・科波克是目前資料庫中唯一對應「Coppock 曲線」的核心專家。"
    },
    {
      "slug": "correlation",
    ...
    },
    {
      ...
      "siteSlug": "demarker",
      "nameZh": "DeMarker 指標",
      "summary": "DeMarker 透過高低價變化衡量需求壓力，常用於尋找潛在超買超賣區。",
      "signals": [
      ...
      "judgmentZh": "湯姆・迪馬克是目前資料庫中唯一對應「DeMark 指標」的核心專家。"
    },
    {
      "slug": "dmi",
      "siteSlug": "dmi",
    ...
    },
    {
      ...
      "judgmentZh": "理查・唐奇安是目前資料庫中唯一對應「唐奇安通道」的核心專家。"
    },
    {
      "slug": "dpo",
      "siteSlug": "dpo",
      ...
      "judgmentZh": "約翰・艾勒斯優勝，因其在原創性、專屬性與資料覆蓋上最強；主要對照者為威廉・江恩、拉爾夫・尼爾森・艾略特。"
    },
    {
      "slug": "ease-of-movement",
      "siteSlug": "ease-of-movement",
      "nameZh": "簡易波動指標",
      "summary": "EOM 衡量價格移動是否需要大量成交量，協助觀察升跌是否輕鬆。",
      "signals": [
        "EOM 上升代表價格上行相對順暢。",
        "EOM 接近零代表價格推進效率低。"
      ],
    ...
    },
    {
      ...
      "judgmentZh": "亞歷山大・艾爾德是目前資料庫中唯一對應「Elder-Ray」的核心專家。"
    },
    {
      "slug": "ema",
      "siteSlug": "ema",
      ...
      "judgmentZh": "傑拉德・阿佩爾優勝，因其在原創性、專屬性與資料覆蓋上最強；主要對照者為約翰・墨菲、羅伯特・科爾比。"
    },
    {
      ...
      "judgmentZh": "喬・迪納波利優勝，因其在原創性、專屬性與資料覆蓋上最強；主要對照者為卡洛琳・波羅登、羅伯特・邁納。"
    },
    {
      ...
      "judgmentZh": "約翰・艾勒斯是目前資料庫中唯一對應「Ehlers 濾波器」的核心專家。"
    },
    {
      "slug": "force-index",
      ...
      "judgmentZh": "亞歷山大・艾爾德是目前資料庫中唯一對應「Force Index」的核心專家。"
    },
    {
      "slug": "heikin-ashi",
      ...
      "judgmentZh": "史蒂夫・尼森優勝，因其在原創性、專屬性與資料覆蓋上最強；主要對照者為湯瑪斯・布考斯基、本間宗久。"
    },
    {
      ...
      "judgmentZh": "約翰・布林格優勝，因其在原創性、專屬性與資料覆蓋上最強；主要對照者為安德魯・思拉舍、亞歷克斯・斯皮羅格魯。"
    },
    {
      "slug": "hma",
      "siteSlug": "hma",
      "nameZh": "赫爾移動平均線",
      "summary": "HMA 透過加權與平方根週期降低延遲，常被用來觀察較平滑但反應較快的趨勢變化。",
      "signals": [
      ...
      "judgmentZh": "艾倫・霍爾是目前資料庫中唯一對應「Hull 移動平均」的核心專家。"
    },
    {
      "slug": "ichimoku",
      "siteSlug": "ichimoku",
      ...
      "judgmentZh": "細田悟一是目前資料庫中唯一對應「一目均衡表」的核心專家。"
    },
    {
      "slug": "kama",
      "siteSlug": "kama",
      ...
      "judgmentZh": "佩里・考夫曼是目前資料庫中唯一對應「KAMA 考夫曼自適應均線」的核心專家。"
    },
    {
      "slug": "kdj",
      "siteSlug": "kdj",
      ...
      "judgmentZh": "喬治・藍恩是目前資料庫中唯一對應「隨機指標」的核心專家。"
    },
    {
    ...
    },
    {
      ...
      "judgmentZh": "理查・唐奇安優勝，因其在原創性、專屬性與資料覆蓋上最強；主要對照者為威廉・彼得・漢密爾頓、達利・古比。"
    },
    {
      "slug": "ma-ribbon",
      "siteSlug": "ma-ribbon",
    ...
    },
    {
      ...
      "siteSlug": "macd",
      "nameZh": "指數平滑異同移動平均線",
      "summary": "MACD 結合趨勢與動能，透過快慢 EMA 差值觀察趨勢強弱、金叉死叉與背離。",
      "signals": [
      ...
      "judgmentZh": "傑拉德・阿佩爾優勝，因其在原創性、專屬性與資料覆蓋上最強；主要對照者為亞歷克斯・斯皮羅格魯。"
    },
    {
      "slug": "mass-index",
      "siteSlug": "mass-index",
    ...
    },
    {
      ...
      "judgmentZh": "謝爾曼・麥克萊倫、瑪麗安・麥克萊倫並列優勝；此指標/方法屬共同創作或共同權威，應並讀其資料。"
    },
    {
      "slug": "mfi",
      "siteSlug": "mfi",
      ...
      "judgmentZh": "金・匡、阿夫魯姆・蘇達克並列優勝；此指標/方法屬共同創作或共同權威，應並讀其資料。"
    },
    {
      "slug": "momentum",
      "siteSlug": "momentum",
    ...
    },
    {
      ...
      "judgmentZh": "約瑟夫・格蘭維爾是目前資料庫中唯一對應「OBV 能量潮」的核心專家。"
    },
    {
      "slug": "percent-b",
      "siteSlug": "percent-b",
    ...
    },
    {
      ...
      "judgmentZh": "羅伯特・愛德華茲、約翰・麥基並列優勝；此指標/方法屬共同創作或共同權威，應並讀其資料。"
    },
    {
      "slug": "ppo",
      "siteSlug": "ppo",
    ...
    },
    {
      ...
      "judgmentZh": "威爾斯・威爾德是目前資料庫中唯一對應「Parabolic SAR」的核心專家。"
    },
    {
      "slug": "put-call-ratio",
      ...
      "judgmentZh": "傑森・戈普弗特優勝，因其在原創性、專屬性與資料覆蓋上最強；主要對照者為內德・戴維斯、艾德森・古爾德。"
    },
    {
      "slug": "pvi",
      "siteSlug": "pvi",
    ...
    },
    {
      ...
      "nameZh": "相對強弱比較",
      "summary": "RSC 用個股與指數或同業比較，找出相對強勢或弱勢標的。",
      "signals": [
        "RSC 上升代表個股跑贏比較基準。",
      ...
      "judgmentZh": "威廉・歐尼爾優勝，因其在原創性、專屬性與資料覆蓋上最強；主要對照者為查爾斯・柯克派翠克二世、蓋瑞・安東納奇。"
    },
    {
    ...
    },
    {
      ...
      "judgmentZh": "湯瑪斯・布考斯基優勝，因其在原創性、專屬性與資料覆蓋上最強；主要對照者為茱莉・達爾奎斯特、羅伯特・愛德華茲。"
    },
    {
      "slug": "roc",
      "siteSlug": "roc",
    ...
    },
    {
      ...
      "judgmentZh": "威爾斯・威爾德優勝，因其在原創性、專屬性與資料覆蓋上最強；主要對照者為拉倫斯・康納斯、康斯坦絲・布朗。"
    },
    {
      "slug": "sma",
      "siteSlug": "sma",
    ...
    },
    {
      ...
      "judgmentZh": "圖沙・昌德優勝，因其在原創性、專屬性與資料覆蓋上最強；主要對照者為史丹利・克羅爾。"
    },
    {
      "slug": "supertrend",
      "siteSlug": "supertrend",
      ...
      "judgmentZh": "奧利維耶・塞班是目前資料庫中唯一對應「SuperTrend」的核心專家。"
    },
    {
    ...
    },
    {
      ...
      "judgmentZh": "理查・阿姆斯是目前資料庫中唯一對應「TRIN / Arms Index」的核心專家。"
    },
    {
      "slug": "trix",
      "siteSlug": "trix",
      "nameZh": "三重指數平滑平均",
      "summary": "TRIX 透過三重平滑降低雜訊，適合觀察較乾淨的中期動能轉向。",
      "signals": [
      ...
      "judgmentZh": "傑克・哈特森是目前資料庫中唯一對應「TRIX」的核心專家。"
    },
    {
      "slug": "tsi",
      "siteSlug": "tsi",
    ...
    },
    {
      ...
      "nameZh": "成交量震盪器",
      "summary": "Volume Oscillator 比較短長期成交量均線，幫助辨識量能是否正在擴張。",
      "signals": [
        "VO 高於零代表短期成交量高於長期平均。",
        "VO 上升代表量能擴張。",
        "突破時 VO 同步轉正，訊號較完整。"
    ...
    },
    {
      ...
      "judgmentZh": "彼得・史戴梅爾優勝，因其在原創性、專屬性與資料覆蓋上最強；主要對照者為詹姆斯・道爾頓。"
    },
    {
      ...
      "judgmentZh": "艾蒂安・博特斯、道格拉斯・西普曼並列優勝；此指標/方法屬共同創作或共同權威，應並讀其資料。"
    },
    {
      "slug": "vwap",
      "siteSlug": "vwap",
      ...
      "judgmentZh": "布萊恩・香農是目前資料庫中唯一對應「VWAP / Anchored VWAP」的核心專家。"
    },
    {
      "slug": "williams-r",
      "siteSlug": "williams-r",
      ...
      "judgmentZh": "拉瑞・威廉斯是目前資料庫中唯一對應「Williams %R」的核心專家。"
    },
    {
      "slug": "wma",
      "siteSlug": "wma",
    ...
    },
    {
      ...
      "judgmentZh": "本間宗久優勝，因其在原創性、專屬性與資料覆蓋上最強；主要對照者為艾倫・安德魯斯、傑克・施瓦格。"
    }
  ],
  "terms": {
    "PF": {
