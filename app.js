...
const indicatorInput = [
  {
    ...
    difficulty: "入門",
    params: "20、50、200 期",
    formula: "SMA = N 期收盤價總和 / N",
    summary:
      "SMA 用固定期間的平均收盤價平滑短期雜訊，常用來判斷趨勢方向與中長線支撐壓力。",
    signals: [
  ...
  },
  {
    ...
    formula: "EMA = 今日收盤價 x 平滑係數 + 昨日 EMA x (1 - 平滑係數)",
    summary:
  ...
  },
  {
    ...
    difficulty: "入門",
    params: "14、3、3",
    formula: "%K = (收盤價 - N 期最低價) / (N 期最高價 - N 期最低價) x 100",
    summary:
      "KD 觀察收盤價在近期高低區間中的位置，對區間震盪和短線轉折較敏感。",
    signals: [
  ...
  },
  {
    ...
    difficulty: "入門",
    params: "12、20、25 期",
    formula: "ROC = (今日收盤價 - N 期前收盤價) / N 期前收盤價 x 100",
    summary:
  ...
  },
  {
    ...
    difficulty: "入門",
    params: "10、20 期",
    formula: "Momentum = 今日收盤價 - N 期前收盤價",
    summary:
  ...
  },
  {
    ...
    formula: "%R = (N 期最高價 - 收盤價) / (N 期最高價 - N 期最低價) x -100",
    summary:
      "Williams %R 與 KD 概念相近，用負值表示收盤價相對高低區間的位置。",
    signals: [
  ...
  },
  {
    ...
    summary:
      "CMF 觀察收盤價在日內高低區間的位置並結合成交量，評估累積或派發壓力。",
    signals: [
      "CMF 高於零，代表資金流入傾向較明顯。",
      "CMF 轉負而價格仍高位，需留意承接不足。",
    ],
    mistakes: ["忽略跳空和高低價異常對指標的影響。"],
  ...
  },
  {
    ...
    difficulty: "進階",
    params: "10 或 14 期",
    formula: "RVI 比較收盤價相對開盤價的力度並以高低區間標準化",
    summary:
...
const humanSummaryBySlug = {
  ...
  stochastic: "KD 看收盤價在近期高低位中的位置。橫行市有用；強勢股高位鈍化時，逆勢做空很容易被挾。",
...
const glossary = [
  ...
  ["金叉", "短週期線上穿長週期線，常被視為動能改善訊號。"],
  ["死叉", "短週期線下穿長週期線，常被視為動能轉弱訊號。"],
...
const marketRegimeGuides = [
  ...
  {
    regime: "恐慌/消息市",
    signal: "跳空、長陰長陽、成交急增，指標短期失真。",
    use: "先降低倉位或只觀察，等待波動收斂和結構重建。",
    tools: "ATR、成交量、VWAP、陰陽燭確認",
    avoid: "不要把普通參數直接套用在異常行情；消息日滑價和跳空風險更大。",
  },
];
...
const categoryTeachingProfiles = {
  ...
  波動率: {
    ...
    calculation:
      "波動類指標重點是高低價、收盤價或標準差的穩定計算；遇到除權、停牌復牌或跳空日，應理解數值可能短期扭曲。",
    advanced:
...
const categoryDeepDiveProfiles = {
  ...
  "通道/型態": {
    ...
    calibration: [
      "固定畫線規則：用收盤價還是影線、看多少個高低點、是否允許假突破，都要先寫清楚。",
...
const indicatorDeepDiveOverrides = {
  ...
  atr: {
    ...
    calibration: [
      ...
      "跳空日和財報日會推高 ATR，需判斷是一次性事件還是新波動 regime。",
...
const categoryTradeProfiles = {
  趨勢: {
    ...
    trigger:
      "等收盤價確認突破，或突破後回踩不跌破關鍵位再入場；不要在指標剛轉向的一刻衝入。",
...
const strategyCaseDetailProfiles = {
  "connors-rsi2": {
    ...
    bestWhen: [
      ...
      "標的是 SPY、QQQ、IWM 等流動性高、隔夜跳空相對可控的產品。",
    ],
    avoidWhen: [
    ...
    executionFlow: [
      ...
      ["確認趨勢", "日線收盤價必須高於 200MA，否則即使 RSI(2) 很低也先不交易。"],
  ...
  "williams-r": {
    thesis:
      "Williams %R 和 RSI 一樣，都是用來看短線有沒有過熱或過冷；不同的是，它更直接看收盤價貼近近期高位還是低位。",
    readerTakeaways: [
  ...
  "three-down-days": {
    ...
    avoidWhen: [
      ...
      "把規則搬到個股而沒有檢查財報、停牌、流動性和跳空風險。",
    ],
    executionFlow: [
      ["定義連跌", "明確寫出三日收盤價是否每日低於前一日收盤，避免主觀判斷。"],
